...
var author$project$Main$Model = F7(
	function (currentPage, highlightedButton, urlkey, url, indexurl, windowWidth, windowHeight) {
		return {currentPage: currentPage, highlightedButton: highlightedButton, indexurl: indexurl, url: url, urlkey: urlkey, windowHeight: windowHeight, windowWidth: windowWidth};
	});
...
var author$project$Main$getindexurl = function (url) {
	...
	function (flags, url, key) {
		return _Utils_Tuple2(
			A7(
				...
				author$project$Main$urlToPageName(url),
				'none',
				key,
				url,
				author$project$Main$getindexurl(url),
...
var author$project$Main$changeUrl = F3(
...
var author$project$Main$changeByName = F2(
	function (model, pageName) {
		var newurl = function () {
			var _n0 = elm$url$Url$fromString(
				A2(
		...
		switch (msg.$) {
			...
			case 'LinkClicked':
				...
				if (urlRequest.$ === 'Internal') {
					...
					return A2(
						author$project$Main$changeByName,
						model,
						author$project$Main$urlToPageName(url));
				} else {
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					A2(
						author$project$Main$changeByName,
						model,
						author$project$Main$urlToPageName(url)).a,
					elm$core$Platform$Cmd$none);
			case 'MouseOver':
				var pageName = msg.a;
				return _Utils_Tuple2(
...
var author$project$Main$gameCanvas = function (model) {
	return rtfeldman$elm_css$Html$Styled$fromUnstyled(
		A3(
			joakin$elm_canvas$Canvas$toHtml,
			_Utils_Tuple2(model.windowWidth - 30, model.windowHeight - 30),
			_List_fromArray(
				[
					elm$html$Html$Attributes$id('gamecanvas')
				]),
			_List_Nil));
};
...
var author$project$Main$listing = F3(
	function (imgName, title, model) {
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$src(imgName),
		...
		[
			...
			_List_fromArray(
				[
					...
					A3(rtfeldman$elm_css$Css$rgb, 165, 220, 255)),
					rtfeldman$elm_css$Css$height(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('FLOW')
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									A3(rtfeldman$elm_css$Css$rgb, 247, 54, 105)),
									rtfeldman$elm_css$Css$display(rtfeldman$elm_css$Css$inlineBlock)
								]))
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Deluxe')
						]))
				]))
		]));
var author$project$Main$MouseLeave = function (a) {
	return {$: 'MouseLeave', a: a};
};
var author$project$Main$MouseOver = function (a) {
	return {$: 'MouseOver', a: a};
};
var author$project$Main$PageChange = function (a) {
	return {$: 'PageChange', a: a};
};
var author$project$Main$pageBackgroundColor = A3(rtfeldman$elm_css$Css$rgb, 229, 229, 208);
...
var author$project$Main$pagebutton = F2(
	function (pageName, model) {
		var buttonPageColor = _Utils_eq(pageName, model.currentPage) ? author$project$Main$pageColor : author$project$Main$pageBackgroundColor;
		return A2(
			rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Events$onClick(
					author$project$Main$PageChange(pageName)),
					rtfeldman$elm_css$Html$Styled$Events$onMouseOver(
					author$project$Main$MouseOver(pageName)),
					rtfeldman$elm_css$Html$Styled$Events$onMouseLeave(
					author$project$Main$MouseLeave(pageName)),
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$width(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							author$project$Main$makePage,
							'Game',
							author$project$Main$gameCanvas(model),
							model)
						])))
			]),
		title: 'flow deluxe'
