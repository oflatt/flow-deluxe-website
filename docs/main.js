...
var author$project$Main$Model = F5(
	function (currentPage, highlightedButton, urlkey, url, indexurl) {
		return {currentPage: currentPage, highlightedButton: highlightedButton, indexurl: indexurl, url: url, urlkey: urlkey};
	});
