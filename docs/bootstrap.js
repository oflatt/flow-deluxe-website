...
/******/
/******/ 		var wasmModules = {"0":["../pkg/flow_game_bg.wasm"]}[chunkId] || [];
/******/
...
eval("// A dependency graph that contains any wasm must all be imported\n// asynchronously. This `bootstrap.js` file does the single async import, so\n// that no one else needs to worry about it again.\n__webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./flow-game-main.js */ \"./flow-game-main.js\"))\n  .catch(e => console.error(\"Error importing `flow-game-main.js`:\", e));\n\n\n//# sourceURL=webpack:///./bootstrap.js?");
